...
namespace ctrlspec.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(CtrlSpecDbContext context, ClientRepository client ,IEmailService emailService,IConfiguration configuration )
        {
            _context = context;
            _client= client;
        ...
        {
            var admins = await _client.GetAll();
            if (admins == null)
            {
                return NotFound();
            }
        ...
        {
            var app = await _client.GetByID(Id);
            if (app == null)
            {
                return NotFound();
            }
